...
-- =============================================================================
-- Role + User setup (run as SYSADMIN — not ACCOUNTADMIN)
-- =============================================================================
...
-- GRANT SERVICE ROLE GRAGEN_DB.GRAGEN.GRAGEN_SERVICE!ALL_ENDPOINTS_USAGE TO ROLE GRAGEN_DB;
